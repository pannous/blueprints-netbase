...
import com.tinkerpop.blueprints.impls.netbase.NetbaseGraph;
import com.tinkerpop.blueprints.util.PropertyFilteredIterable;
import com.tinkerpop.blueprints.util.io.graphml.GraphMLReader;
import org.Netbase.index.impl.lucene.LowerCaseKeywordAnalyzer;
 ...
 */
public class NetbaseBatchGraphTest extends BaseTest {

    public void testFeatureCompliance() {
        final String directory = this.getWorkingDirectory();
        final NetbaseBatchGraph batch = new NetbaseBatchGraph(directory);
    ...
    public void testAddingVerticesEdges() {
        ...
        // native netbase graph load

        final Graph graph = new NetbaseGraph(directory);
    ...
    public void testAddingVerticesEdgesWithIndices() {
        ...
        final NetbaseGraph graph = new NetbaseGraph(directory);
    ...
    public void testElementPropertyManipulation() {
        ...
        NetbaseGraph graph = new NetbaseGraph(directory);
        assertEquals(count(graph.getVertices()), 10);
    ...
    public void testIndexParameters() throws Exception {
        ...
        IndexableGraph graph = new NetbaseGraph(directory);
